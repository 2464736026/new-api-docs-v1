...
description: Memoh integration guide — Connect the self-hosted containerized AI agent platform to New API, creating AI bots with long-term memory for Telegram, Discord, Lark, QQ, WeChat, and more.
---
...
After registering and logging in to NewAPI, click "Console" in the left sidebar, then click "Token Management", and click the "Add Token" button to create a new API Key. Select the appropriate permissions and click "Create".
